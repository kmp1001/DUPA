...
class ReWriteRootDirCli(LightningCLI):
    ...
    def instantiate_trainer(self, **kwargs: Any) -> Trainer:
        ...
        # revised
        # You can run experiments for many times with different names
        if os.path.exists(default_root_dir) and os.listdir(default_root_dir) and self.subcommand != "predict" and not is_resume:
