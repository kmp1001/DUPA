...
# Todo：support different model size for gradient logging
# def SiT_XL_2(**kwargs):
...
def SiT_B_2(**kwargs):
    return DDT(in_channels= 4, patch_size= 2, num_groups= 12, hidden_size= 768, num_blocks= 12, num_classes= 1000, attn_begin= 1, attn_end= 2, **kwargs)
