...
class REPATrainer(BaseTrainer):
    ...
    def _impl_trainstep(self, net, ema_net, raw_images, x, y, step):
        ...
        if self.use_dog_bank_align:
            ...
            #     temperature=self.gate_temperature,
            # )
            enc_gate_weights_b, enc_band_energy = _frequency_energy_weights(
                pred_enc,
                enc_hw,
                self.enc_bank_names,
                sigmas=self.dog_sigmas,
            ...
            dec_gate_weights_b, dec_band_energy = _frequency_energy_weights(
                pred_dec,
                dec_hw,
                self.dec_bank_names,
                sigmas=self.dog_sigmas,
            ...
            loss_enc_align, enc_band_losses, enc_gate_weights = _adaptive_weighted_band_cosine_loss(
                pred_enc,
                enc_target_bank,
                self.enc_bank_names,
                enc_gate_weights_b,
            )
            loss_dec_align, dec_band_losses, dec_gate_weights = _adaptive_weighted_band_cosine_loss(
                pred_dec,
                dec_target_bank,
                self.dec_bank_names,
                dec_gate_weights_b,
